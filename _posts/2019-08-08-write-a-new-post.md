...
This post will guide you how to write a post on _Chirpy_ theme.-0 Even if you have previous experience with Jekyll, this article is worth reading, because many features require specific variables to be set.
